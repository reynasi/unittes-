...
class meterialTest(unittest.TestCase):
    def setUp(self):
        global driver
    ...
    @BeautifulReport.add_test_img('test_meterial_cn')
    def test_meterial_cn(self):
        """material：.cn方式访问内容分布式开发平台并登录"""
        project = "material"
        ...
        try:
            ...
            result = is_element_exist(driver, "//*[@id='root']/div/section/aside/div/div[1]/a/img", project + '登陆后元素存在判定')
        except:
            traceback.print_exc()
        finally:
            self.assertEqual(result, 'true')

    @BeautifulReport.add_test_img('test_meterial_com')
    def test_meterial_com(self):
        """material：.com方式访问内容分布式开发平台并登录"""
        project = "material"
        mobil_xpath = "//*[@id='mobile']"
        code_xpath = "//*[@id='code']/input"
        btn_xpath = "//*[@id='root']/div/div[1]/form/button"
