...
class partnersTest(unittest.TestCase):
    def setUp(self):
        global driver
    ...
    @BeautifulReport.add_test_img('test_partners_cn')
    def test_partners_cn(self):
        """partners_cn：酷培合作伙伴"""
        project = 'partners'
    ...
    @BeautifulReport.add_test_img('test_partners_com')
    def test_partners_com(self):
        """partners_com：酷培合作伙伴"""
        project = 'partners'
        mobil_xpath = '//*[@id="mobile"]'
        code_xpath = "//*[@id='code']/input"
