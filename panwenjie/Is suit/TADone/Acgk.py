...
class algoTestdemo(unittest.TestCase):
    ...
    def testcpk(self):
        ...
        # 发送卡片
        qwes = {'orgId': orgId, 'homeworkName': "练习闯关闯关卡测试1", 'tasks':  [{'courseId': "63533", 'taskId': 6753621}]}
        ...
        loginOrgPostdata = {'openId': "", 'randomCode': cardid, 'shareType': "homework", 'username': '算法测试','mobile': username,'code': code}
