...
class algoTestdemo(unittest.TestCase):
    ...
    def testjixu(self):
        ...
        loginOrgResponsedata = requests.get(
            ...
            headers=headers)
        print(loginOrgResponsedata.json())
        # 获取taskExecutionId
...
if(platform.system()=='Windows'):
    ...
    print(platform.system())
    runner.report(filename='酷培算法接口测试.html', description='酷培算法接口测试', log_path=report_dir)
    print(report_dir)
    print(filename)
elif(platform.system()=='Linux'):
    report_dir = "/opt/uitest/report"
    filename = '/opt/uitest/img'
    runner.report(filename='酷培算法接口测试.html', description='酷培算法接口测试', report_dir=report_dir)
    print(report_dir)
    print(filename)
    print(platform.system())
else:
