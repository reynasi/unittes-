    ...
    def testkupcyc(self):
        ...
        SDASD = requests.get(
            'https://cj.learnta.cn/__api/beatV3/studentClassroom/chapter?chapterId=' + str(
                chapterId) + '&studyRoomId=' + str(intelligentRoomId)+'&orgId='+str(orgId), headers=headers)
        ...
        # 获取taskExecutionId
        asdasdf = {'intelligentStudyRoomTopicId': chapterId, 'orgId': orgId, 'kpointId': kpointId ,'studyRoomId':intelligentRoomId}
