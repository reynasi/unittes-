...
if (platform.system() == 'Windows'):
    ...
    cpassword = config.get("Info", "password")
    corgId = config.get("Info", "orgid")
...
class algoTestdemo(unittest.TestCase):
    ...
    def testtadljgk(self):
        ...
        #换知识点
        kpointId = SDASD.json()['data']['kpoints'][0]['kpointId']
        print(kpointId)
...
if(platform.system()=='Windows'):
    ...
    print(platform.system())
    runner.report(filename='TAD智能学习算法接口测试.html', description='TAD智能学习算法接口测试', log_path=report_dir)
    print(report_dir)
    print(filename)
elif(platform.system()=='Linux'):
    report_dir = "/opt/uitest/report"
    filename = '/opt/uitest/img'
    runner.report(filename='TAD智能学习算法接口测试.html', description='TAD智能学习算法接口测试', report_dir=report_dir)
    print(report_dir)
    print(filename)
    print(platform.system())
else:
