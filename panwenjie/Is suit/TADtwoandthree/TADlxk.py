...
class algoTestdemo(unittest.TestCase):
    ...
    def testlxk(self):
        ...
        # 获取   questionId
            ...
            question = requests.post('https://learnta.cn/__api/beatV3/student/task/17/' + str(taskExecutionId) + '/question',
            ...
            data = requests.put('https://learnta.cn/__api/beatV3/student/task/17/'+str(taskExecutionId)+'/answer',data = json.dumps(data2),headers = headers)
