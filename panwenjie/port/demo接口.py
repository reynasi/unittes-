...
class algoTestdemo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        loginOrgPostdata = {"openId": "", "randomCode": 2173, "shareType": "homework", "username": 1231,
        ...
        self.token = loginOrgResponsedata.json()['data']['token']
        print(self.token)
    def tearDown(self):
        pass
    ...
    def testWork(self):
        ...
        # 拿goUrl
        goUrlResponsedata=requests.get('https://t2.learnta.cn/__api/beatV3/student/task/3/308096/question',headers=headers)
