...
class Clasdw(unittest.TestCase):
    ...
    def testContinue(self):
        ...
        WebDriverWait(driver,20).until(EC.presence_of_element_located(
            (By.XPATH, '//*[@id="root"]/section/main/div[2]/div/div[3]/div/div[2]/div[2]/div[2]/div/div[1]/img')))
        driver.find_element_by_xpath('//*[@id="root"]/section/main/div[2]/div/div[3]/div/div[2]/div[2]/div[2]/div/div[1]/img').click()
        WebDriverWait(driver,20).until(EC.presence_of_element_located(
