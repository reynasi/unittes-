...
class Clasdw(unittest.TestCase):
    ...
    def testCapture(self):
        ...
        # 选择第一个知识点立即攻克
        WebDriverWait(driver,20).until(EC.presence_of_element_located(
            (By.XPATH, '/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/div[2]/div[2]/div[1]/div/div[3]/button')))
        driver.find_element_by_xpath(
            '/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/div[2]/div[2]/div[1]/div/div[3]/button').click()
        # 点击继续按钮
        WebDriverWait(driver,20).until(EC.presence_of_element_located(
            (By.XPATH, '//*[@id="root"]/div/div/div/div/div[2]/div/div[2]/div')))
        sleep(5)
...
#循环做题
    ...
    def testWeakness(self):
        ...
        while find_yxy(driver):
            ...
            print(num)
            driver.find_element_by_xpath(
                '/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/div[2]/div[2]/div[%d]/div/div[3]/button' % (
                    num,)).click()
            num += 1
            sleep(1)
            try:
    ...
    def testBegin(self):
        ...
        # 点击开始学习
        WebDriverWait(driver,20).until(EC.presence_of_element_located(
            (By.XPATH, '//*[@id="root"]/section/main/div[1]/div[2]/div/div/div[2]/div/button')))
        driver.find_element_by_xpath('//*[@id="root"]/section/main/div[1]/div[2]/div/div/div[2]/div/button').click()

        try:
            result = is_element_exist(self.driver,
                                     '/html/body/div[5]/div/div[2]/div/div[2]/div')
        except:
            traceback.print_exc()
        finally:
            if result == 'true':
                driver.find_element_by_xpath('/html/body/div[5]/div/div[2]/div/div[2]/div/div[3]').click()
        ...
        while find_yxy(driver):
            ...
            print(num)
            driver.find_element_by_xpath(
                '/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div[1]/div[2]/div[2]/div[%d]/div/div[3]/button' % (
                    num,)).click()
            num += 1
            sleep(1)
            try:
    ...
    def testtest(self):
        ...
        loginOrgPostdata = {"username": 15021201249, "code": 1111, "systemCode": "dms"}
